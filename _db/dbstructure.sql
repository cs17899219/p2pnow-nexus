...
(1, 'SceneTorrents mod', 'scenetorrents/', 'pic/category/chd/scenetorrents/catsprites.css', 'yes', 'no', 'P2Pnow Nexus', 'Modified from SceneTorrents');
...
(12, 12, 25, 'item', '我从哪里可以搞到源代码的拷贝？', '这个Tracker使用的是P2Pnow Nexus的代码。代码获取事宜，请看<a class="faqlink" href="aboutnexus.php">这里</a>。<br />\r\nP2Pnow Nexus的代码是根据TBSource的源码改写的。TBDev网站，Tracker源代码以及社区论坛都在这里：<a class="faqlink" href="http://www.tbdev.net/">TBDev.net</a>。', 1, 1, 3),
...
(312, 12, 28, 'item', '我從哪裡可以搞到來源碼的拷貝？', '這個Tracker使用的是P2Pnow Nexus的程式碼。程式碼抓取事宜，請看<a class="faqlink" href="aboutnexus.php">這裡</a>。<br />\r\nP2Pnow Nexus的程式碼是根據TBSource的源碼改寫的。TBDev網站，Tracker來源碼以及社區論壇都在這裡：<a class="faqlink" href="http://www.tbdev.net/">TBDev.net</a>。', 1, 1, 3),
...
(412, 12, 6, 'item', 'Where can I get a copy of the source code?', 'This tracker is powered by P2Pnow Nexus. If you like to use P2Pnow Nexus to power your tracker, <a class="faqlink" href="aboutnexus.php">Contact Us</a>.<br />\r\nThe first stage of P2Pnow Nexus forks from TBSource. You may find more information about TBSource at <a class="faqlink" href="http://www.tbdev.net/">TBDev.net</a>.', 1, 1, 3),
