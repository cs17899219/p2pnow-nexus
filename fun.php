...
if ($action == 'delete')
{
	...
	if (!$sure)
		stderr($lang_fun['std_delete_fun'],$lang_fun['text_please_click'] ."<a class=altlink href=?action=delete&id=$id&returnto=".rawurlencode($returnto)."&sure=1>".$lang_fun['text_here_if_sure'],false);
